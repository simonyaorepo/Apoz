  ...
  return (
    <OverviewSection
      ...
      content={[
        ...
        `Our industrial parks at full buildout will feature ${PHASE_ONE_DATA.stageTwo.details.industrial.squareFootage} of industrial space across ${PHASE_ONE_DATA.acreage} acres. This development is designed to accommodate advanced manufacturing, warehousing, distribution centers, logistics operations, and global trade facilities.`,
