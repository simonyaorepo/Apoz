...
export const PHASE_1_DATA = {
  ...
  objectives: [
    "Infrastructure Development: Roads, utilities, data connectivity",
    "Anchor Tenants: Attract initial manufacturing & distribution tenants",
    "Financial Close: Raise funds via QOF, REITs, and strategic LPs",
    "Regulatory Activation: FTZ approval, environmental permits, construction readiness"
  ],
  timeline: [
    {
  ...
  financing: {
    targetRaise: "~$24MM",
    sources: [
      "Equity via QOF — For tax-incentivized investors",
      "Strategic LPs / Family Offices",
      "Bank Debt & Construction Loans",
      "Potential REIT exit or IPO conversion"
    ],
    returns: {
...
export const PHASE_2_DATA = {
  ...
  objectives: [
    "Workforce Demand: Provide attainable housing for the ~2,000+ workers generated by the industrial park, retail, and logistics facilities in Phase 1.",
    "Stabilize Land Value: Develop the residential component to elevate surrounding property values and attract complementary commercial services.",
    "Leverage QOZ Incentives: Tap into Qualified Opportunity Zone benefits to defer, reduce, or eliminate capital gains taxes on appreciation.",
    "Promote Community Integration: Incorporate walkable streets, community centers, green spaces, and easy connections to Phase 1's employment hubs."
  ],
  scope: {
  ...
  financing: {
    ...
    sources: [
      "QOF Equity (~30–40%): Tax-advantaged capital from QOZ investors seeking deferral, reduction, or elimination of capital gains.",
      "LIHTC Syndication (~15–25%): Tax credit equity sold to institutional buyers (banks, corporations) in exchange for project equity.",
      "Private LPs & Co-Investors (~15–20%): Family offices, impact investors, and institutional partners seeking stable yields + social returns.",
      "Senior Debt & Construction Loans (~25–35%): Bank financing (HUD, Freddie Mac, Fannie Mae multi-family programs) at favorable rates given the QOZ and LIHTC structure."
    ],
    benefits: [
      "10-Year Hold + Tax-Free Gains on Appreciation: QOZ investors who hold for 10+ years pay zero capital gains tax on the upside of the Residential Village.",
      "LIHTC-Enhanced Returns: Up to 9% LIHTC credits improve overall project economics and attract institutional equity at lower cost of capital.",
      "Steady Cash Flow: Rental income from ~2,000 units stabilizes returns and reduces downside volatility.",
      "Exit Flexibility: The project can evolve from rental to for-sale units over time, unlocking realized gains as the market appreciates."
    ]
  },
  timeline: [
    {
  ...
  synergy: [
    "Phase 1 Employment Anchor: Industrial tenants generate steady workforce demand, ensuring high occupancy and minimal vacancy risk.",
    "Integrated Community: Workers live, work, and shop within a walkable, master-planned ecosystem—reducing commute times and increasing quality of life.",
    "Land Value Uplift: Successful Phase 1 operations boost surrounding land values, making Phase 2 Residential development more feasible and profitable.",
    "Dual QOZ Benefits: Both phases leverage QOZ tax incentives, multiplying investor appeal and creating compounding financial advantages."
  ]
};
