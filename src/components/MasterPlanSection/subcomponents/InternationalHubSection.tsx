        ...
        <ContentGrid>
            ...
            <IllustrationBox>
              <svg viewBox="0 0 650 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="150" cy="200" r="60" stroke="currentColor" strokeWidth="2" fill="none"/>
                <ellipse cx="150" cy="200" rx="60" ry="25" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <line x1="150" y1="140" x2="150" y2="260" stroke="currentColor" strokeWidth="1.5"/>
                <path d="M120 170 Q150 185 180 170" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <path d="M120 230 Q150 215 180 230" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                
                {/* Connection arrows */}
                <line x1="210" y1="200" x2="280" y2="200" stroke="currentColor" strokeWidth="2"/>
                <path d="M265 190 L280 200 L265 210" stroke="currentColor" strokeWidth="2" fill="none"/>
                
                {/* Trade/Hub center */}
                <rect x="300" y="160" width="120" height="80" stroke="currentColor" strokeWidth="2" fill="none"/>
                <text x="360" y="205" textAnchor="middle" fontSize="18" fontWeight="bold" fill="#0a3a3f">HUB</text>
                
                {/* Outgoing connections */}
                <line x1="420" y1="180" x2="480" y2="150" stroke="currentColor" strokeWidth="2"/>
                <path d="M470 145 L480 150 L470 157" stroke="currentColor" strokeWidth="2" fill="none"/>
                
                <line x1="420" y1="200" x2="480" y2="200" stroke="currentColor" strokeWidth="2"/>
                <path d="M465 190 L480 200 L465 210" stroke="currentColor" strokeWidth="2" fill="none"/>
                
                <line x1="420" y1="220" x2="480" y2="250" stroke="currentColor" strokeWidth="2"/>
                <path d="M470 243 L480 250 L470 255" stroke="currentColor" strokeWidth="2" fill="none"/>
                
                {/* Destination nodes */}
                <rect x="490" y="130" width="80" height="40" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="490" y="180" width="80" height="40" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="490" y="230" width="80" height="40" stroke="currentColor" strokeWidth="2" fill="none"/>
              </svg>
            </IllustrationBox>
          </ContentGrid>
      </WhiteSection>
