...
const IndustryZoneManagementSection: React.FC<IndustryZoneManagementSectionProps> = () => {
        ...
        <ContentGrid>
            ...
            <IllustrationBox>
              <svg viewBox="0 0 650 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Bonded warehouse */}
                <rect x="210" y="200" width="110" height="110" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="210" y1="255" x2="320" y2="255" stroke="currentColor" strokeWidth="1.5"/>
                <rect x="225" y="220" width="30" height="25" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <rect x="270" y="220" width="30" height="25" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <rect x="225" y="270" width="30" height="25" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <rect x="270" y="270" width="30" height="25" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                
                {/* Truck/Logistics */}
                <rect x="360" y="250" width="90" height="60" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="375" y="235" width="20" height="15" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <circle cx="380" cy="310" r="12" stroke="currentColor" strokeWidth="2" fill="none"/>
                <circle cx="430" cy="310" r="12" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="365" y1="265" x2="445" y2="265" stroke="currentColor" strokeWidth="1"/>
                
                {/* Customs gate/checkpoint */}
                <rect x="480" y="240" width="45" height="70" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="502" y1="240" x2="502" y2="210" stroke="currentColor" strokeWidth="2"/>
                <rect x="492" y="205" width="20" height="12" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                
                {/* Security camera */}
                <circle cx="560" cy="220" r="18" stroke="currentColor" strokeWidth="2" fill="none"/>
                <path d="M 545 220 L 560 210 L 575 220" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="555" y="238" width="10" height="15" stroke="currentColor" strokeWidth="1.5" fill="none"/>
              </svg>
            </IllustrationBox>
        </ContentGrid>
      </WhiteSection>
