        ...
        <ContentGrid>
            ...
            <IllustrationBox>
              <svg viewBox="0 0 650 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M 145 240 L 170 215 L 195 240" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="150" y="240" width="40" height="70" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="160" y="255" width="10" height="12" stroke="currentColor" strokeWidth="1" fill="none"/>
                <rect x="175" y="255" width="10" height="12" stroke="currentColor" strokeWidth="1" fill="none"/>
                
                {/* Park/Green space */}
                <circle cx="260" cy="270" r="25" stroke="currentColor" strokeWidth="2" fill="none"/>
                <circle cx="240" cy="290" r="18" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <circle cx="280" cy="295" r="15" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                
                {/* Community center */}
                <rect x="330" y="230" width="90" height="80" stroke="currentColor" strokeWidth="2" fill="none"/>
                <rect x="345" y="250" width="25" height="30" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <rect x="380" y="250" width="25" height="30" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                <circle cx="375" cy="220" r="8" stroke="currentColor" strokeWidth="1.5" fill="none"/>
                
                {/* Playground */}
                <rect x="450" y="280" width="35" height="30" stroke="currentColor" strokeWidth="2" fill="none"/>
                <circle cx="467" cy="265" r="10" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="467" y1="275" x2="467" y2="280" stroke="currentColor" strokeWidth="2"/>
                
                {/* People icons */}
                <circle cx="520" cy="270" r="12" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="520" y1="282" x2="520" y2="300" stroke="currentColor" strokeWidth="2"/>
                <line x1="520" y1="288" x2="510" y2="295" stroke="currentColor" strokeWidth="2"/>
                <line x1="520" y1="288" x2="530" y2="295" stroke="currentColor" strokeWidth="2"/>
                
                <circle cx="555" cy="270" r="12" stroke="currentColor" strokeWidth="2" fill="none"/>
                <line x1="555" y1="282" x2="555" y2="300" stroke="currentColor" strokeWidth="2"/>
                <line x1="555" y1="288" x2="545" y2="295" stroke="currentColor" strokeWidth="2"/>
                <line x1="555" y1="288" x2="565" y2="295" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </IllustrationBox>
          </ContentGrid>
      </WhiteSection>
